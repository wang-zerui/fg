...
export class FunctionGraphClient {
  ...
  public async updateFunction(
    updateFuncionRequest: UpdateFunctionRequest
  ): Promise<any> {
   ...
   * @returns
   */
  public async updateFunctionConfig(
    updateFunctionConfigRequest: UpdateFunctionConfigRequest
  ): Promise<any> {
    const options = ParamCreater().updateFunctionConfig(
  ...
  public async getFunctionList(
    ...
    const options = ParamCreater().getFunctionList(
...
export const ParamCreater = function () {
  return {
    ...
    updateFunction(
      ...
      if (func_urn === null || func_urn === undefined) {
        throw new RequiredError(
          "function_urn",
          "Required parameter function_urn"
        );
      }
    ...
    updateFunctionConfig(
      ...
      let func_urn: any;
      if (
        updateFunctionConfigRequest !== null &&
        updateFunctionConfigRequest !== undefined
      ) {
        if (
          updateFunctionConfigRequest instanceof UpdateFunctionConfigRequest
        ) {
    ...
    updateTrigger(
      ...
      if (trigger_type_code === null || trigger_type_code === undefined) {
        throw new RequiredError(
          "trigger_type_code",
          "Required parameter trigger_type_code"
        );
      }
