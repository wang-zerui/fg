...
export class CreateTriggerRequestBody {
    ...
    public constructor(trigger_type_code?: string, trigger_status?: string, event_type_code?: string, event_date?:object){
    ...
    public withTriggerTypeCode(trigger_type_code: string): CreateTriggerRequestBody {
        this['trigger_type_code'] = trigger_type_code;
        return this;
    }
