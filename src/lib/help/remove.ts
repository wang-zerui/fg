    ...
    content: [
      {
        desc: "all",
        example:
          "Remove all resources, you can get help through [s remove all -h]",
      },
      {
        desc: "function",
        example:
          "Only remove function resources, you can get help through [s remove function -h]",
      },
      {
        desc: "trigger",
        example:
          "Only remove trigger resources, you can get help through [s remove trigger -h]",
      },
    ],
  },
];
